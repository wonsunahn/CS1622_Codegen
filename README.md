...
* logs/, logs_solution/, log_diffs/ : Symbol table + text format AST that you already saw for Project 3 (yours / solution / diff).
* asts/, asts_solution/, ast_diffs/ : Abstract syntax tree images that you already saw for Project 2 (yours / solution / diff).
